...
export const ADD_EVENT_MENU_ITEMS = {
  meal: { id: 'meal', label: 'Ho mangiato', icon: '🥗', borderColor: undefined },
  water: {
    id: 'water',
    label: 'Ho bevuto acqua',
    icon: '💧',
