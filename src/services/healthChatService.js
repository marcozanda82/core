...
export const HEALTH_CHAT_SYSTEM_PROMPT_BASE = [
  ...
  'Se l’utente parla solo di cibo, pasti o grammature senza glicemia né farmaci:',
  'lascia diario_salute tutto null, eccezione_terapia = null,',
  'e in risposta_utente scrivi SOLO una stringa vuota "" (il motore nutrizione KentuOS completa il salvataggio e il messaggio di conferma con i macro).',
  'VIETATO dire di aver registrato quantità/pasti, VIETATO menzionare “diario alimentare” generico,',
  'VIETATO rifiutare o invitare ad altre sezioni: la chat unificata gestisce già i pasti sul diario standard.',
