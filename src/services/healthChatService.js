...
export const HEALTH_CHAT_SYSTEM_PROMPT_BASE = [
  ...
  'eccezione_terapia = null, e in risposta_utente conferma in modo breve che il pasto va gestito dal flusso nutrizione',
  '(es. «Ok, registro il pasto nel diario alimentare.»). VIETATO rifiutare, VIETATO dire “usa un’altra sezione”,',
  'VIETATO invitare a lasciare la chat: la chat unificata gestisce già i pasti.',
