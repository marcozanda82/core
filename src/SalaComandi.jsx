...
Esempio: {"desc":"${name}","kcal":120,"prot":25,"carb":0,"fatTotal":2,"fibre":0}`;
  ...
  if (isFullScreenGraph) {
    ...
    return (
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#121212', zIndex: 99999, display: 'flex', flexDirection: 'column' }}>
        {/* 1. HEADER FISSO */}
        ...
        <div ref={fullscreenChartScrollRef} style={{ flex: 1, width: '100%', minHeight: 0, overflowX: 'auto', overflowY: 'hidden', WebkitOverflowScrolling: 'touch', position: 'relative' }}>
          <div style={{ width: `${220 * zoomLevel}%`, minWidth: `${800 * zoomLevel}px`, height: '100%', minHeight: '100%', display: 'flex', flexDirection: 'column', paddingBottom: '30px', transition: 'width 0.3s ease' }}>
            ...
            <div className="timeline-strip-container" style={{ height: '80px', marginTop: '12px', marginBottom: '30px', position: 'relative', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid #222', flexShrink: 0, zIndex: 10 }}>
