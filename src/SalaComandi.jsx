...
export default function SalaComandi() {
  ...
  const estraiDatiFoodDbRef = useRef(null);
  const getAverageEstimateRef = useRef(null);
  ...
  getAverageEstimateRef.current = getAverageEstimate;
  ...
  estraiDatiFoodDbRef.current = estraiDatiFoodDb;
