...
/**
 * Portale fullscreen Neural Reset (Zen).
 * Riceve stato/metodi da `useNeuralResetSession` via props.
 *
 * @param {{
 *   open?: boolean,
 *   onBack?: () => void,
 *   isZenActive?: boolean,
 *   zenBreathPhase?: string|null,
 *   zenSunScale?: number,
 *   audioMode?: string,
 *   zenForestAmbientOn?: boolean,
 *   zenBreathPatternId?: string,
 *   setZenBreathPatternId?: (id: string) => void,
 *   zenSessionDurationKey?: string,
 *   setZenSessionDurationKey?: (key: string) => void,
 *   zenGracefulEnd?: boolean,
 *   zenSunTransitionMs?: number,
 *   zenSunDimHold?: boolean,
 *   zenTimerLine?: string|null,
 *   neuralResetAudioRef?: React.RefObject,
 *   neuralResetBellRef?: React.RefObject,
 *   zenAmbientForestRef?: React.RefObject,
 *   toggleSeaAudio?: () => void,
 *   toggleForestAmbient?: () => void,
 *   toggleZenSession?: () => void,
 *   exitZenView?: () => void,
 *   patterns?: Record<string, { id: string, label: string, hint?: string }>,
 *   durationOptions?: Array<{ value: string, label: string }>,
 * }} props
 */
export default function NeuralResetZenPortal({
  open = false,
  onBack = null,
  isZenActive = false,
  zenBreathPhase = null,
  zenSunScale = 1,
  audioMode = 'muted',
  zenForestAmbientOn = false,
  zenBreathPatternId = 'square',
  setZenBreathPatternId = null,
  zenSessionDurationKey = '3',
  setZenSessionDurationKey = null,
  zenGracefulEnd = false,
  zenSunTransitionMs = 4000,
  zenSunDimHold = false,
  zenTimerLine = null,
  neuralResetAudioRef = null,
  neuralResetBellRef = null,
  zenAmbientForestRef = null,
  toggleSeaAudio = null,
  toggleForestAmbient = null,
  toggleZenSession = null,
  exitZenView = null,
  patterns = {},
  durationOptions = [],
}) {
  ...
  const durationList = Array.isArray(durationOptions) ? durationOptions : [];
  ...
  return createPortal(
    ...
    >
      ...
      <p style={{ flexShrink: 0, textAlign: 'center', color: 'rgba(255,255,255,0.85)', fontSize: '0.75rem', margin: '0 20px 24px', lineHeight: 1.5 }}>
        {patterns?.[zenBreathPatternId]?.hint ?? ''}
      </p>
      <div
        style={{
          position: 'relative',
