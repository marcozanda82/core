...
REGOLA TASSATIVA: Il campo foodName (name) DEVE contenere SOLO il nome dell'alimento da cercare nel database. Rimuovi le congiunzioni (e, con, ed) e rimuovi le quantità dal nome. VIETATO: "e 160 g di pane integrale".`,
        ...
        "HARD CONSTRAINT — LETTERALITÀ ANTI-ALLUCINAZIONE: NON inferire ricette complesse o piatti pronti se l'utente indica un ingrediente singolo semplice. Esempi: 'passato di pomodoro' / 'passata di pomodoro' → foodName «Passata di pomodoro» (VIETATO pizza/sugo elaborato); 'cous cous con verdure' → «Cous cous con verdure» (VIETATO farro/quinoa se non detti); 'fagioli rossi mais peperoncino' → mantieni i singoli ingredienti O una voce mista coerente (VIETATO collassare solo su «mais»). Se l'alimento esatto non è nel DB, usa isNewFood:true col nome letterale detto — NON forzare un match semantico errato.",
        "REGOLA ADD_FOOD (isNewFood): Imposta isNewFood:true se l utente nomina un piatto specifico, ricetta casalinga, prodotto commerciale O un ingrediente semplice assente dal DB Kentu / [userRecentFoods]. isNewFood:false o ometti per pane, pasta, yogurt, pollo già presenti. Con isNewFood:true NON scomporre in ingredienti (Priorità 2 VIETATA) — una sola voce col nome detto dall utente.",
        ...
        "REGOLA ADD_FOOD (DIGIUNO 0 KCAL — OBBLIGATORIA): Se il pasto/bevanda ha 0 kcal (es. caffè amaro, tè, acqua; campo kcal:0 nel payload/diario), IL DIGIUNO NON È INTERROTTO. In payload.message NON dire che il digiuno è rotto/interrotto: se c'è digiuno attivo, complimentati per averlo mantenuto. Solo pasti >10 kcal o caffè zuccherato interrompono.",
        "REGOLA ADD_FOOD (CAFFERIA / IL SOLITO): Se l'utente chiede caffè/cappuccino/macchiato/croissant/«il solito», usa Coffee_Shop_Context.catalog o [COFFEE_SHOP_DATABASE]. Copia ESATTI kcal/P/C/F, caffeineMg, isFastingSafe in userProvidedMacros + campi dedicati — VIETATO inventare.",
