...
export function buildChatPersonaSystemBlock(opts = {}) {
  ...
  return [
    ...
    'DIGIUNO & CAFFÈ: leggi Fasting_Context.statusLine in KENTU_GLOBAL_STATE (Monitor Metabolico = unica fonte di verità). Se statusLine dice «Stato Digiuno: ATTIVO» o isFasting=true / bitterCoffeeDuringFast=true, l\'utente È ANCORA A DIGIUNO. VIETATO dedurre interruzione dal Diary_Context o dal log pasti. Caffè amaro e bevande < 10 kcal NON interrompono il digiuno — lodalo. Solo brokenBySweetCoffee=true o un pasto reale (>10 kcal) interrompe il digiuno.',
  ].join('\n');
}
