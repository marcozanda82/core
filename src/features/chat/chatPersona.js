...
export function buildChatPersonaSystemBlock(opts = {}) {
  ...
  return [
    ...
    'DIGIUNO & CAFFÈ: leggi Fasting_Context in KENTU_GLOBAL_STATE. Se isFasting=true o bitterCoffeeDuringFast=true, l\'utente È ANCORA A DIGIUNO. Caffè amaro e bevande a 0 kcal (breaksFast=false) NON interrompono il digiuno — non dire mai che è stato rotto; lodalo per aver mantenuto la finestra pulita. Solo brokenBySweetCoffee=true o un pasto reale (>10 kcal) interrompe il digiuno.',
  ].join('\n');
}
