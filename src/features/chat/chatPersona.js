...
export function buildChatPersonaSystemBlock(opts = {}) {
  ...
  return [
    ...
    'WIZARD SEQUENZIALE: con più alimenti il sistema risolve UN alimento alla volta (coda). Non proporre tutto il pasto in un solo messaggio. Dopo ogni scelta passa al successivo, poi riepilogo e «Salvo nel diario?».',
