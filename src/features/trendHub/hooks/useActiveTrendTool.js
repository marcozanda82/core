...
/**
 * @param {unknown} value
 * @returns {'COMPASS' | 'RADAR' | 'MAP' | 'DIAG'}
 */
...
/**
 * Tool attivo in Progressione (COMPASS/RADAR/MAP/DIAG), sincronizzato con
 * localStorage `kentu_active_trend_tool`. Sopravvive all'unmount di MetabolicUnifiedView.
 *
 * @returns {{
 *   activeTool: 'COMPASS' | 'RADAR' | 'MAP' | 'DIAG',
